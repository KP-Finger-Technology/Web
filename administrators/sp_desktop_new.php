...
$q = mysql_query('SELECT MAX(desktopid) as desktopid from `pagedesktop`');
$row = mysql_fetch_assoc($q);
$next_auto_inc = $row['desktopid'] + 1;
...
if($_GET) {
	if(isset($_POST['btnSave'])){
		...
		$sqlCek="SELECT * FROM pagedesktop WHERE tittle='$txttittle'";
		...
		if(count($message)==0){			
			$qrySave=mysql_query("INSERT INTO pagedesktop SET desktopid='', tittle='$txttittle', content='$txtcontent', picture='$nama_file'") or die ("Gagal query".mysql_error());
			if($qrySave){
				$qryLogs=mysql_query("INSERT INTO logs SET logid='', userid='".$_SESSION['userid']."', trans='NEW', tab='Desktop', des='Data telah ditambahkan', servicetime='".$tanggal."'");
            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="?page=products">Desktop Apps</a></li>
                        <li class="active">New Desktop Apps</li>
                    </ol>
                </section>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    <form role="form" action="?page=sp_desktop_new" method="post" name="frmedit" target="_self" id="frmedit" enctype="multipart/form-data">
                                        <!-- text input -->
