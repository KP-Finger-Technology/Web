...
if (isset($_POST['name']))
{
	...
	$cek_login=mysql_num_rows($login);
		...
		else
		{
			...
			//echo "asup";
			echo "<script> document.location.href='akses.php?go=masuk'; </script>";
		}
}
?>
...
<form id="form" name="form" action="index.php" method="post">
	<div id="block">
		...
		<input type="submit" id="submit" name="submit" value="v" onClick="return cek_login()" />
	</div>
</form>
<div id="option"> 
	<p>Sign in</p> 
