...
if($_GET) {
	if(isset($_POST['btnSave'])){
		...
		if(count($message)==0){			
			$qryUpdate=mysql_query("UPDATE pagewebs SET tittle='$txttittle', content='$txtcontent', picture='$nama_file' WHERE webid ='".$txtKode."'")or die ("Gagal query".mysql_error());
			if($qryUpdate){
				$qryLogs=mysql_query("INSERT INTO logs SET logid='', userid='".$_SESSION['userid']."', trans='EDIT', tab='Web', des='Data telah diubah', servicetime='".$tanggal."'");
            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="?page=products">Web Design</a></li>
                        <li class="active">Edit Web Desgin</li>
                    </ol>
                </section>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    <form role="form" action="?page=sp_web_edit" method="post" name="frmedit" target="_self" id="frmedit" enctype="multipart/form-data">
                                        <!-- text input -->
                                        ...
                                        <div class="form-group">
                                            <label>Picture</label>
                                            <img src="../images/web/<?php echo $pictureLama; ?>" width="150" />
