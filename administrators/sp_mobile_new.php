...
$q = mysql_query('SELECT MAX(mobileid) as mobileid from `pagemobiles`');
$row = mysql_fetch_assoc($q);
$next_auto_inc = $row['mobileid'] + 1;
...
if($_GET) {
	if(isset($_POST['btnSave'])){
		...
		$direktori	="../images/mobile/$nama_file";
		move_uploaded_file($lokasi_file,$direktori);
									
		# Validasi Nama barang, jika sudah ada akan ditolak
		$sqlCek="SELECT * FROM pagemobiles WHERE tittle='$txttittle'";
		...
		if(count($message)==0){			
			$qrySave=mysql_query("INSERT INTO pagemobiles SET mobileid='', tittle='$txttittle', content='$txtcontent', picture='$nama_file'") or die ("Gagal query".mysql_error());
			if($qrySave){
				$qryLogs=mysql_query("INSERT INTO logs SET logid='', userid='".$_SESSION['userid']."', trans='NEW', tab='Mobile', des='Data telah ditambah', servicetime='".$tanggal."'");
            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="?page=products">Mobile Apps</a></li>
                        <li class="active">New Products Mobile Apps</li>
                    </ol>
                </section>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Mobile Data Table</h3>                                    
                                </div><!-- /.box-header -->
                                <div class="box-body">
                                    <form role="form" action="?page=sp_mobile_new" method="post" name="frmedit" target="_self" id="frmedit" enctype="multipart/form-data">
                                        <!-- text input -->
