...
if($_GET) {
	if(isset($_POST['btnSave'])){
		...
		if(count($message)==0){			
			$qryUpdate=mysql_query("UPDATE pageproducts SET tittle='$txttittle', content='$txtcontent', picture='$nama_file' WHERE productsid ='".$txtKode."'")or die ("Gagal query".mysql_error());
			if($qryUpdate){
				$qryLogs=mysql_query("INSERT INTO logs SET logid='', userid='".$_SESSION['userid']."', trans='EDIT', tab='Product', des='Data telah diubah', servicetime='".$tanggal."'");
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    <form role="form" action="?page=products_edit" method="post" name="frmedit" target="_self" id="frmedit" enctype="multipart/form-data">
                                        <!-- text input -->
                                        ...
                                        <div class="form-group">
                                            <label>Picture</label>
                                            <img src="../images/<?php echo $pictureLama; ?>" width="150" />
