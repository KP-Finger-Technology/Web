...
if($_GET) {
	if(isset($_POST['btnSave'])){
		...
		if(count($message)==0){			
			$qryUpdate=mysql_query("UPDATE pagemobiles SET tittle='$txttittle', content='$txtcontent', picture='$nama_file' WHERE mobileid ='".$txtKode."'")or die ("Gagal query".mysql_error());
			if($qryUpdate){
				$qryLogs=mysql_query("INSERT INTO logs SET logid='', userid='".$_SESSION['userid']."', trans='EDIT', tab='Mobile', des='Content data telah diubah', servicetime='".$tanggal."'");
            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Edit Mobile</li>
                    </ol>
                </section>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Mobile Apps Data Table</h3>                                    
                                </div><!-- /.box-header -->
                                <div class="box-body">
                                    <form role="form" action="?page=sp_mobile_edit" method="post" name="frmedit" target="_self" id="frmedit" enctype="multipart/form-data">
                                        <!-- text input -->
                                        ...
                                        <div class="form-group">
                                            <label>Picture</label>
                                            <img src="../images/mobile/<?php echo $pictureLama; ?>" width="150" />
