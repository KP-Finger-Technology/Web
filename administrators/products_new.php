...
$q = mysql_query('SELECT MAX(productsid) as productsid from `pageproducts`');
...
if($_GET) {
	if(isset($_POST['btnSave'])){
		...
		$sqlCek="SELECT * FROM pageproducts WHERE tittle='$txttittle'";
		...
		if(count($message)==0){			
			$qrySave=mysql_query("INSERT INTO pageproducts SET productsid='', tittle='$txttittle', content='$txtcontent', picture='$nama_file'") or die ("Gagal query".mysql_error());
			if($qrySave){
				$qryLogs=mysql_query("INSERT INTO logs SET logid='', userid='".$_SESSION['userid']."', trans='NEW', tab='Products', des='Data telah ditambahkan', servicetime='".$tanggal."'");
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    <form role="form" action="?page=products_new" method="post" name="frmedit" target="_self" id="frmedit" enctype="multipart/form-data">
                                        <!-- text input -->
